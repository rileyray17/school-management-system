							...
							<form method="POST" action="{{ route('register') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="name" name="name" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Name">
									</div>
								</div>
								  ...
								  <div class="row">
									<div class="col-12">
									  <div class="checkbox text-white">
										...
										<label for="basic_checkbox_1">I agree to the <a href="'.route('terms.show').'" class="text-warning"><b>Terms</b></a></label>
									  </div>
									</div>
									<!-- /.col -->
